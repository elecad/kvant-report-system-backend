...
export class createEventDto {
  @IsString({
    message: 'Наименование мероприятия должно быть строкой',
    groups: [VALIDATOR_GROUP.base],
  })
  @IsNotEmpty({
    message: 'Необходимо наименование мероприятия',
    groups: [VALIDATOR_GROUP.base],
  })
  @ApiProperty({
  ...
  @IsDateString(
    {},
    { message: 'Это поле должно быть датой', groups: [VALIDATOR_GROUP.base] },
  )
  @IsNotEmpty({
    message: 'Необходимо дата и время проведения мероприятия',
    groups: [VALIDATOR_GROUP.base],
  })
  @ApiProperty({
  ...
  @IsString({
    message: 'Описание мероприятия должно быть строкой',
    groups: [VALIDATOR_GROUP.base],
  })
  @IsNotEmpty({
    message: 'Необходимо описание проведения мероприятия',
    groups: [VALIDATOR_GROUP.base],
  })
  @ApiProperty({
  ...
  @IsNotEmpty({
    message: 'Необходимо ID Места проведения мероприятия',
    groups: [VALIDATOR_GROUP.base],
  })
