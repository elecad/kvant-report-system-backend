...
export class DataOfTypeTableController {
  constructor(private readonly dataOfTypeTableService: DataOfTypeTableService) {}
  ...
  findOne(@Param('id') id: string) {
    return this.dataOfTypeTableService.findOne(+id);
  }

  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDataOfTypeTableDto: UpdateDataOfTypeTableDto) {
